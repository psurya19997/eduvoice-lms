...
export default function NarrateBody({ session, placements, onPlace, onUndo, disabled, onOpenHint }) {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 gap-3">
      ...
      {publicImageUrl && (
        <div className="w-full aspect-video rounded-2xl overflow-hidden bg-slate-200 ring-1 ring-slate-200/50 shadow-sm shrink-0">
          <img
            src={publicImageUrl}
            alt="Context"
